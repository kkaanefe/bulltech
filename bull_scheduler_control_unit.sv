    ...
    if(rst) begin 
        ...
        PREP:begin 
            ...
            if(prebuf_cyc_cnt >= PREBUFFER_CYCLES) begin 
                ...
                due_reg <= cycle_cnt; //BURASI SIKINTILI OLABİLİR ZAMANLAMA AÇISINDAN AKLINDA TUT
                t_go <= cycle_cnt;
                fire <= 1'b0;
                state <= WAIT;
            end
...
logic empty_fifo_alarm_reg;
assign empty_fifo_alarm = !s_axis.tvalid || !mon_axis.tvalid;
